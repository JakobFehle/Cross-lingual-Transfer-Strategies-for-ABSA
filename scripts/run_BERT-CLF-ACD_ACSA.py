...
#     for DATA_SETTING, LANG_SETTING in [['multi-od', 'orig']]:
...
#                                                         ] if DATA_SETTING != 'balanced' else [])):
#             for TASK in ['acd', 'acsa']:
#                 for BASE_EPOCHS in [5, 10, 15]:
#                     for LEARNING_RATE in [2e-5]:
#                         for BATCH_SIZE in [16]:
#                             if (DATA_SETTING == 'balanced' and LANG_SETTING == 'orig') or 'multi' in DATA_SETTING:
