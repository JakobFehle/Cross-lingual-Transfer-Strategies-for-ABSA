...
class ACSAProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        # sentiment = ['-1', '0', '1', '2']
        # aspect_list = ['AMBIENCE#GENERAL', 'DRINKS#PRICES', 'DRINKS#QUALITY', 'DRINKS#STYLE_OPTIONS', 'FOOD#PRICES', 'FOOD#QUALITY', 'FOOD#STYLE_OPTIONS', 'LOCATION#GENERAL',  'RESTAURANT#GENERAL', 'RESTAURANT#MISCELLANEOUS', 'RESTAURANT#PRICES', 'SERVICE#GENERAL']

        # return [aspect_list, sentiment]
    ...
    def _create_examples(self, df, set_type):
        ...
        for (index, row) in df.iterrows():
            ...
            for label in row['labels']:
                ...
                labels.append(f'{label[0].upper().replace(" ", "#")}#{sentiment}')
            text_b = None
