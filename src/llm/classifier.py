...
def init_args():
    ...
    parser.add_argument("--data_setting", default="orig", choices=["orig", "balanced", "multi_id", "multi_od", "cs", "translated"], type=str)
    ...
    if test:
        ...
        for idx, example in dataset.iterrows():
            if task == 'tasd':
                ...
                output = [tuple([labels[0], labels[1]]) for labels in example["labels"]]
                output = str(list(set(output)))
            elif task == 'acd':
                output = [labels[0] for labels in example["labels"]]
                output = str(list(set(output)))
...
if __name__ == '__main__':
    ...
    res_config_1, res_config_2 = None, None
    ...
    if args.data_setting in ['balanced', 'cs', 'translated']:
    ...
    if 'eval' not in args.eval_type:
        if args.lang != 'tr':
            ...
            res_config_1 = f"{args.output_dir}{args.task}_{args.lang}_{args.lang_setting}_{args.eval_type}_{args.data_setting}-b_{args.learning_rate}_{args.train_batch_size}_{args.num_train_epochs}_{args.seed}/"
        ...
        res_config_2 = f"{args.output_dir}{args.task}_{args.lang}_{args.lang_setting}_{args.eval_type}_{args.data_setting}-o_{args.learning_rate}_{args.train_batch_size}_{args.num_train_epochs}_{args.seed}/"
        ...
        res_config_1 = f"{args.output_dir}{args.task}_{args.lang}_{args.lang_setting}_{args.eval_type}_{args.data_setting}-o_{args.learning_rate}_{args.train_batch_size}_{args.num_train_epochs}_{args.seed}/"
        res_config_2 = None
    ...
    if args.eval_only:
        ...
        if res_config_1:
            cmd.extend(["--evaluation_data_1", res_config_1])
