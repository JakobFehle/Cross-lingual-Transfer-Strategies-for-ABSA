...
def loadDataset(data_path, language, setting):
    ...
    if 'multi' not in setting:
        if 'cs' in setting:
            path_train = f'{data_path}/{language}/train_translated_cs.json'
            path_eval = f'{data_path}/{language}/test_b.json'
        ...
        elif 'translated' in setting:
            path_train = f'{data_path}/{language}/train_translated_b.json'
            path_eval = f'{data_path}/{language}/test_b.json'
