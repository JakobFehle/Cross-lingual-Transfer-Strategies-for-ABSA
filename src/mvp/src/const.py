...
# cate_list = {
#     "rest-de": de_aspect_cate_list,
#     "rest-en": en_aspect_cate_list,
#     "rest-nl": nl_aspect_cate_list,
#     "rest-es": es_aspect_cate_list,
#     "rest-fr": fr_aspect_cate_list,
#     "rest-ru": ru_aspect_cate_list,
#     "rest-cs": cs_aspect_cate_list,
#     "rest-tr": tr_aspect_cate_list,
# }
...
# force_words = {
#     'tasd': {
#         "rest-de": de_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['de'].values()) + ['[SSEP]'],
#         "rest-en": en_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['en'].values()) + ['[SSEP]'],
#         "rest-nl": nl_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['nl'].values()) + ['[SSEP]'],
#         "rest-es": es_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['es'].values()) + ['[SSEP]'],
#         "rest-fr": fr_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['fr'].values()) + ['[SSEP]'],
#         "rest-ru": ru_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['ru'].values()) + ['[SSEP]'],
#         "rest-cs": cs_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['cs'].values()) + ['[SSEP]'],
#         "rest-tr": tr_aspect_cate_list + list(POLARITY_MAPPINGS_POL_TO_TERM['tr'].values()) + ['[SSEP]'],
#     }
# }
